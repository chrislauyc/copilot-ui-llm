...
import { getWorkspaceHostLocation } from "../../src/agentCore/workspace";
import { getTask } from '../../src/orchestration/db/taskStore';
...
`;
    ...
    const { getGitSandbox } = await import('../../src/agentCore/workspace');
