...
import { PRESET_SCENARIOS } from '../../src/ui/mockEvents';
import { TASK_TYPE_GATE_MAP } from '../../src/config/gates';
import { SIMULATOR_SSE_EVENTS, FAILED_SIMULATOR_SSE_EVENTS, ERROR_SIMULATOR_SSE_EVENTS } from '../fixtures/mockStreamPayloads';
