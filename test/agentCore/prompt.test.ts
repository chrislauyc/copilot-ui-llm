...
import { cleanSubprocessLogs, enforceWorkingMemoryTruncation, SlidingWindowCircularBuffer } from '../../src/agentCore/contextManager';
...
runTest('Dynamic Token-Weight Scale Factors: shifting tiers shifts input character budget calculations', async () => {
    const { DEFAULT_ROLES_CONFIG } = await import('../../src/config/models');
